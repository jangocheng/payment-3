...
type WXRefundResponse struct {
	...
	coupon_type_0       string   `xml:"coupon_type_0" sign:"true"`
	coupon_refund_fee_0 string   `xml:"coupon_refund_fee_0" sign:"true"`
	coupon_refund_id_0  string   `xml:"coupon_refund_id_0" sign:"true"`
	coupon_type_1       string   `xml:"coupon_type_1" sign:"true"`
	coupon_refund_fee_1 string   `xml:"coupon_refund_fee_1" sign:"true"`
	coupon_refund_id_1  string   `xml:"coupon_refund_id_1" sign:"true"`
	coupon_type_2       string   `xml:"coupon_type_2" sign:"true"`
	coupon_refund_fee_2 string   `xml:"coupon_refund_fee_2" sign:"true"`
	coupon_refund_id_2  string   `xml:"coupon_refund_id_2" sign:"true"`
}
